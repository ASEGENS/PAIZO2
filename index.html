...
<head>
    ...
    <title>Pathfinder 2 - Accueil</title>
    ...
    <section class="about py-5 bg-light">
        <div class="container">
            <div class="row d-flex align-items-center">
                <div class="col-md-6">
                    <h2>À propos de Pathfinder 2</h2>
        ...
        <div class="container">
            <div class="row text-center">
                <div class="col-md-4 mb-3">
                    ...
                    <h3>Créatures Épiques</h3>
                    <p>Affrontez des créatures mythiques et vivez des aventures fabuleuses.</p>
                </div>
                <div class="col-md-4 mb-3">
                    <i class="fas fa-magic fa-3x mb-3"></i>
                    <h3>Magie</h3>
                    <p>Découvrez et apprenez à utiliser des sorts divers et variés.</p>
                </div>
                <div class="col-md-4 mb-3">
                    <i class="fas fa-map-marked-alt fa-3x mb-3"></i>
                    <h3>Univers unique</h3>
                    <p>Explorez notre monde et découvrez des secrets cachés.</p>
                </div>
            </div>
        </div>
    </section>
